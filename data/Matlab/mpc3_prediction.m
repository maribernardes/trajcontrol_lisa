...
plot_safe_limit_Z('k');
xlabel('Depth [mm]'),ylabel('Guide Z [mm]'); legend('executed', 'safe limit','Location', LEGLOC);
% set(gca,'Xdir','reverse');
xlim([0 100]);
...
%     set(gca,'Xdir','reverse');
    ...
    plot_safe_limit_Z('k');
    xlabel('Depth [mm]'),ylabel('Guide Z [mm]'); legend('executed', 'prediction', 'safe limit', 'Location', LEGLOC);
%     set(gca,'Xdir','reverse');
    xlim([0 100]);
