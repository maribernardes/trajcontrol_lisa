...
T = readtable(strcat(name,'.csv'), 'HeaderLines',1);

% Define sample sizes
i = find(T{:,49}, 1,'first') + 0;   % First sample (when "base" is published)
...
save(strcat(name,'.mat'),'x_needletip','tip','base','aurora_tip','t', 'X', 'Z', 'J', 'target')
